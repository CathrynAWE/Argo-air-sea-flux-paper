...
function [F_CO2]=FCO2(pCO2_sw,pCO2_atm,T,S,u)
...
%    end
   ...
   dpCO2=pCO2_sw-pCO2_atm;     %%calculation of delta pCO2
...
T=T+uni_temp+273.15; %Conversion from Celsius degrees to Kelvin plus uncertainty
S = S + uni_psal; %plus uncertainty
